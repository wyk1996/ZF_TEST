...
//    {XY_HY,		{116,62,125,35},8000, {"116.62.125.35"},		1},
    ...
    {XY_HY, {121,42,236,89}, 5233, {"121.42.236.89"},         1},
...
//    {XY_HY,		{113,31,105,122},8000, {"113.31.105.122"},		1},	 //益虫平台，固定IP地址 //测试升级ip:113.31.105.122测试端口：8000    //正式升级ip：106.75.119.182   正式端口：8000
     {XY_HY,		{106,75,119,182},8000, {"106.75.119.182"},		1},	 ////正式升级ip：106.75.119.182   正式端口：8000
	 // {XY_HY,		{116,62,125,35},8000, {"116.62.125.35"},		1},	 //HY-test
	  //{XY_HY,		{8,136,134,118},8000, {"8.136.134.118"},		1},	 //HY-test
#endif
