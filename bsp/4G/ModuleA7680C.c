...
uint8_t SIM7600Reset()
{
    ...
    {
        Send_AT_CIPCLOSE(i);//关闭网络服务器
    }
    Send_AT_NETCLOSE();//关闭网络协议
...
//    send_k = 0;
    ...
    //复位
    if(++rest > 5)//5次没连上网络服务器且和网络通讯协议则模块复位
    {
...
{
//	printf("SIM7600CmdState.SIM_ExistState = %02x\r\n", SIM7600CmdState.SIM_ExistState);
...
//	printf("SIM7600CmdState.SIM_Regiset = %02X\r\n", num);
...
//	printf("SIM7600CmdState.SIM_Regiset[num] = %d\r\n", num);
//	printf("state = %d\r\n", state);
